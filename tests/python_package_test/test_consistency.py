...
class TestEngine(unittest.TestCase):
    ...
    def test_binary(self):
        ...
        gbm = lgb.LGBMClassifier(**fd.params, force_col_wise=True)
        gbm.fit(X_train, y_train, sample_weight=weight_train)
        gbm.booster_.save_model("sk.txt")
    ...
    def test_regression(self):
        ...
        gbm = lgb.LGBMRegressor(**fd.params, force_col_wise=True)
    ...
    def test_lambdarank(self):
        ...
        gbm = lgb.LGBMRanker(**fd.params, force_col_wise=True)
